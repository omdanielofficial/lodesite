  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `radial-gradient(closest-side, rgba(35, 39, 46, 0.7), #23272E), url('/assets/images/games/other-games/banner-7daystodie.webp')`,
        }}
      >
        <div className="p-10 text-center">
          ...
          Ready to face the zombie horde in 7 Days to Die? Our 7D2D server hosting is designed to ensure you survive and thrive in the post-apocalyptic world.</p>
          <br></br>
          <p className="w-full text-lg md:w-[700px]">
          ...
          <div className="mt-5 flex flex-col items-center justify-between rounded-xl bg-primary p-3 md:flex-row">
            <div className="mb-4 flex gap-2 md:mb-0">
              ...
              <div className="flex flex-col">
                ...
                <p>
                  7 Days To Die requires at least 4GB RAM.
                </p>
              </div>
            </div>
          </div>
