  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `radial-gradient(closest-side, rgba(35, 39, 46, 0.7), #23272E), url('/assets/images/games/other-games/banner-valheim.webp')`,
        }}
      >
        <div className="p-10 text-center">
          ...
          Ready to conquer the world of Valheim? Our Valheim server hosting is here to help you on your epic Viking journey.</p>
          <br></br>
          <p className="w-full text-lg md:w-[700px]">
          ...
          <div className="mt-5 flex flex-col items-center justify-between rounded-xl bg-primary p-3 md:flex-row">
            <div className="mb-4 flex gap-2 md:mb-0">
              ...
              <div className="flex flex-col">
                ...
                <p>
                  Valheim requires at least 4GB RAM.
                </p>
              </div>
            </div>
          </div>
