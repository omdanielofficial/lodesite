  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `radial-gradient(closest-side, rgba(35, 39, 46, 0.7), #23272E), url('/assets/images/games/other-games/banner-projectzomboid.webp')`,
        }}
      >
        <div className="p-10 text-center">
          ...
          Ready to team up with friends and survive the zombie apocalypse? Our Project Zomboid server hosting keeps your survival adventures smooth and lag-free.</p>
          <br></br>
          <p className="w-full text-lg md:w-[700px]">
          ...
          <div className="mt-5 flex flex-col items-center justify-between rounded-xl bg-primary p-3 md:flex-row">
            <div className="mb-4 flex gap-2 md:mb-0">
              ...
              <div className="flex flex-col">
                ...
                <p>
                  Project Zomboid requires at least 4GB RAM.
                </p>
              </div>
            </div>
          </div>
