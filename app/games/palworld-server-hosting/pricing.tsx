  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `radial-gradient(closest-side, rgba(35, 39, 46, 0.7), #23272E), url('/assets/images/games/other-games/banner-palworld.webp')`,
        }}
      >
        <div className="p-10 text-center">
          ...
          Survive, craft, and battle with friends in Palworld. Our Palworld server hosting offers instant setup and lag-free gameplay for endless adventures in a vibrant open world.
          </p>
          <br></br>
          <p className="w-full text-lg md:w-[700px]">
          ...
          <div className="mt-5 flex flex-col items-center justify-between rounded-xl bg-primary p-3 md:flex-row">
            <div className="mb-4 flex gap-2 md:mb-0">
              ...
              <div className="flex flex-col">
                ...
                <p>
                  Palworld requires at least 10GB RAM.
                </p>
              </div>
            </div>
          </div>
