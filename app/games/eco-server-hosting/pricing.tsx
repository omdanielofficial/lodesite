  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `radial-gradient(closest-side, rgba(35, 39, 46, 0.7), #23272E), url('/assets/images/games/other-games/banner-eco.webp')`,
        }}
      >
        <div className="p-10 text-center">
          ...
          Ready to build and balance your world? Our Eco server hosting ensures smooth gameplay. Create, collaborate, and protect the environment with friends anytime.</p>
          <br></br>
          <p className="w-full text-lg md:w-[700px]">
